...
#region  Achievement Map

global._achievements = ds_map_create();
ds_map_set(global._achievements, "entrance1", "ACH_ENTRANCE_1");
ds_map_set(global._achievements, "entrance2", "ACH_ENTRANCE_2");
ds_map_set(global._achievements, "entrance3", "ACH_ENTRANCE_3");
ds_map_set(global._achievements, "medieval1", "ACH_MEDIEVAL_1");
ds_map_set(global._achievements, "medieval2", "ACH_MEDIEVAL_2");
ds_map_set(global._achievements, "medieval3", "ACH_MEDIEVAL_3");
ds_map_set(global._achievements, "ruin1", "ACH_RUIN_1");
ds_map_set(global._achievements, "ruin2", "ACH_RUIN_2");
ds_map_set(global._achievements, "ruin3", "ACH_RUIN_3");
ds_map_set(global._achievements, "dungeon1", "ACH_DUNGEON_1");
ds_map_set(global._achievements, "dungeon2", "ACH_DUNGEON_2");
ds_map_set(global._achievements, "dungeon3", "ACH_DUNGEON_3");
ds_map_set(global._achievements, "badland1", "ACH_BADLAND_1");
ds_map_set(global._achievements, "badland2", "ACH_BADLAND_2");
ds_map_set(global._achievements, "badland3", "ACH_BADLAND_3");
ds_map_set(global._achievements, "graveyard1", "ACH_GRAVEYARD_1");
ds_map_set(global._achievements, "graveyard2", "ACH_GRAVEYARD_2");
ds_map_set(global._achievements, "graveyard3", "ACH_GRAVEYARD_3");
ds_map_set(global._achievements, "farm1", "ACH_FARM_1");
ds_map_set(global._achievements, "farm2", "ACH_FARM_2");
ds_map_set(global._achievements, "farm3", "ACH_FARM_3");
ds_map_set(global._achievements, "saloon1", "ACH_SALOON_1");
ds_map_set(global._achievements, "saloon2", "ACH_SALOON_2");
ds_map_set(global._achievements, "saloon3", "ACH_SALOON_3");
ds_map_set(global._achievements, "plage1", "ACH_BEACH_1");
ds_map_set(global._achievements, "plage2", "ACH_BEACH_2");
ds_map_set(global._achievements, "plage3", "ACH_BEACH_3");
ds_map_set(global._achievements, "forest1", "ACH_FOREST_1");
ds_map_set(global._achievements, "forest2", "ACH_FOREST_2");
ds_map_set(global._achievements, "forest3", "ACH_FOREST_3");
ds_map_set(global._achievements, "space1", "ACH_SPACE_1");
ds_map_set(global._achievements, "space2", "ACH_SPACE_2");
ds_map_set(global._achievements, "space3", "ACH_SPACE_3");
ds_map_set(global._achievements, "minigolf1", "ACH_GOLF_1");
ds_map_set(global._achievements, "minigolf2", "ACH_GOLF_2");
ds_map_set(global._achievements, "minigolf3", "ACH_GOLF_3");
ds_map_set(global._achievements, "street1", "ACH_STREET_1");
ds_map_set(global._achievements, "street2", "ACH_STREET_2");
ds_map_set(global._achievements, "street3", "ACH_STREET_3");
ds_map_set(global._achievements, "sewer1", "ACH_SEWER_1");
ds_map_set(global._achievements, "sewer2", "ACH_SEWER_2");
ds_map_set(global._achievements, "sewer3", "ACH_SEWER_3");
ds_map_set(global._achievements, "industrial1", "ACH_INDUSTRIAL_1");
ds_map_set(global._achievements, "industrial2", "ACH_INDUSTRIAL_2");
ds_map_set(global._achievements, "industrial3", "ACH_INDUSTRIAL_3");
ds_map_set(global._achievements, "freezer1", "ACH_FREEZER_1");
ds_map_set(global._achievements, "freezer2", "ACH_FREEZER_2");
ds_map_set(global._achievements, "freezer3", "ACH_FREEZER_3");
ds_map_set(global._achievements, "chateau1", "ACH_CHATEAU_1");
ds_map_set(global._achievements, "chateau2", "ACH_CHATEAU_2");
ds_map_set(global._achievements, "chateau3", "ACH_CHATEAU_3");
ds_map_set(global._achievements, "kidsparty1", "ACH_KIDSPARTY_1");
ds_map_set(global._achievements, "kidsparty2", "ACH_KIDSPARTY_2");
ds_map_set(global._achievements, "kidsparty3", "ACH_KIDSPARTY_3");
ds_map_set(global._achievements, "war1", "ACH_WAR_1");
ds_map_set(global._achievements, "war2", "ACH_WAR_2");
ds_map_set(global._achievements, "war3", "ACH_WAR_3");
ds_map_set(global._achievements, "pepperman", "ACH_BOSS_1");
ds_map_set(global._achievements, "vigilante", "ACH_BOSS_2");
ds_map_set(global._achievements, "noise", "ACH_BOSS_3");
ds_map_set(global._achievements, "fakepep", "ACH_BOSS_4");
ds_map_set(global._achievements, "pizzaface", "ACH_BOSS_5");
ds_map_set(global._achievements, "sranks1", "ACH_SRANK_1");
ds_map_set(global._achievements, "sranks2", "ACH_SRANK_2");
ds_map_set(global._achievements, "sranks3", "ACH_SRANK_3");
ds_map_set(global._achievements, "sranks4", "ACH_SRANK_4");
ds_map_set(global._achievements, "sranks5", "ACH_SRANK_5");
ds_map_set(global._achievements, "pranks1", "ACH_PRANK_1");
ds_map_set(global._achievements, "pranks2", "ACH_PRANK_2");
ds_map_set(global._achievements, "pranks3", "ACH_PRANK_3");
ds_map_set(global._achievements, "pranks4", "ACH_PRANK_4");
ds_map_set(global._achievements, "pranks5", "ACH_PRANK_5");

ds_map_set(global._achievements, "halloween1", "ACH_HALLOWEEN_1");
ds_map_set(global._achievements, "halloween2", "ACH_HALLOWEEN_2");
