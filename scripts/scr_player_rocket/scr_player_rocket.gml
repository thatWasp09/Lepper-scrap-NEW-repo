function scr_player_rocket()
{
    ...
    if (sprite_index != spr_rocketstart)
    {
        ...
        if islepper
        {
            if key_slap
            {
                movespeed = Approach(movespeed, 16, 0.25)
                ...
                else
                {
                    ...
                    repeat (2)
                    {
                        with (instance_create((x - 35 * xscale), (y + 25), obj_noisedebris))
                            sprite_index = spr_lepperpoop_gibs
                    }
                }
            }
            else
    ...
    if (fightball == false)
    {
        ...
        {
            sprite_index = spr_rocket
            if (grounded && vsp >= 0 && ispeppino && (!islepper))
