function scr_player_knightpepslopes() //gml_Script_scr_player_knightpepslopes
{
    ...
    if (grounded && movespeed > 8 && islepper && move == (-xscale) && (!scr_slope()))
        movespeed -= 0.65
    else if ((grounded && movespeed < 14 && islepper && move != (-xscale) && (!scr_slope())) || movespeed < 8)
        movespeed += 0.045
    ...
    if scr_slope()
    {
        ...
        with (instance_place(x, (y + 1), obj_slope))
        {
            ...
            {
                if (other.movespeed < maxspeed)
                    other.movespeed += accel
            }
            else if other.islepper
            {
                if (other.movespeed > 2)
                {
                    other.movespeed -= accel
                    if (other.move == (-other.xscale))
                        other.movespeed -= 0.7
                }
                else
                {
